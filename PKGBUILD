...
makedepends=('rust' 'cmake' 'python' 'libxkbcommon' 'llvm10')
source=("$pkgname-$pkgver.tar.gz::https://github.com/wasmerio/wasmer/archive/${pkgver}.tar.gz" llvm-10.patch soname.patch)
sha512sums=('c02b97075212a496a4c30a9cfcd6b8ef89cb08bf3e5f9f20bf5f83c63bedb5744e4976ee3641310f6a44d911d670285c8b67c3cb9725acdd632ef5f8880ba4b9' SKIP SKIP)
options=('staticlibs')
